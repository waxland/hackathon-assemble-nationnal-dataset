...
- [x] **Étape 2.1 : Externaliser la Taxonomie**
  - *Action* : Sortir les dictionnaires codés en dur dans `04_generate_themes.py` et `05_generate_keywords.py` pour les placer dans un fichier `config/taxonomy.json`.
...
- [x] **Étape 3.1 : Déterminisme des UUIDs**
...
- [x] **Étape 4.2 : Sécuriser le lancement Docker**
